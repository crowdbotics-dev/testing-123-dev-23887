...
const Untitled2 = () => {
  return <View style={_styles.FXZbBLqj}>
      <View style={_styles.bSKPZsDO}></View><View style={_styles.chDZjLFP}></View><Text style={_styles.fhEcnojd}>Lorem ipsum… </Text><ImageBackground style={_styles.tBbUZGqc} source={{
